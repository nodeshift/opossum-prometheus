...
## [0.6.0](https://github.com/nodeshift/opossum-prometheus/compare/opossum-prometheus-v0.5.0...opossum-prometheus-v0.6.0) (2026-06-24)


### ⚠ BREAKING CHANGES

* remove Node 20 support
* remove Node 18 support ([#108](https://github.com/nodeshift/opossum-prometheus/issues/108))
* Bump supported node.js version ([#91](https://github.com/nodeshift/opossum-prometheus/issues/91))
* 
* drop Node.js 12
...
* add stats (percentiles stats, reponse times) in Prometheus metrics ([#10](https://github.com/nodeshift/opossum-prometheus/issues/10)) ([712fa2d](https://github.com/nodeshift/opossum-prometheus/commit/712fa2d14371df2e7dc5ec07dc806dd1cf9da1af))
* adds option for performance metrics so they can be disabled, default is enabled ([#20](https://github.com/nodeshift/opossum-prometheus/issues/20)) ([2437eca](https://github.com/nodeshift/opossum-prometheus/commit/2437eca65e7e5d55d3685f213c24e589827d2899))
* allow one circuit to be pass in without an array. ([#5](https://github.com/nodeshift/opossum-prometheus/issues/5)) ([02ca8f5](https://github.com/nodeshift/opossum-prometheus/commit/02ca8f5ce08f046bbf179cb714b0b40442d5d5b1)), closes [#4](https://github.com/nodeshift/opossum-prometheus/issues/4)
* allow to add circuits dynamicaly ([#7](https://github.com/nodeshift/opossum-prometheus/issues/7)) ([afbaef2](https://github.com/nodeshift/opossum-prometheus/commit/afbaef2ea0d264877cb16b9dea7b9c7b66535b17))
...
* Change event name to be a label ([#15](https://github.com/nodeshift/opossum-prometheus/issues/15)) ([075b033](https://github.com/nodeshift/opossum-prometheus/commit/075b03399949c1863f56f59b4f9b117838cee584))
* Providing metric prefix for circuit metrics ([#32](https://github.com/nodeshift/opossum-prometheus/issues/32)) ([0d85a86](https://github.com/nodeshift/opossum-prometheus/commit/0d85a86a9f594c58f3f900cb98000e58a9eeb058))
...
* Use options object for all configuration ([#19](https://github.com/nodeshift/opossum-prometheus/issues/19)) ([b353a59](https://github.com/nodeshift/opossum-prometheus/commit/b353a5907212a5eabae420ff4ef06c105f953d3f))
* using semistandard and greenkeeper badge removed ([1d99411](https://github.com/nodeshift/opossum-prometheus/commit/1d994111384a436bdfbefeb74b225202d704f561))
...
* adding release please configuration ([88fc760](https://github.com/nodeshift/opossum-prometheus/commit/88fc760708c9c766943d2ba9ce5d239c6cd0286d))
...
* upgrade standard-version from 7.0.0 to 7.1.0 ([#17](https://github.com/nodeshift/opossum-prometheus/issues/17)) ([2b68517](https://github.com/nodeshift/opossum-prometheus/commit/2b68517ae6902837ff9d94cbcbab11621fba920d))
* upgrade standard-version from 8.0.1 to 8.0.2 ([#30](https://github.com/nodeshift/opossum-prometheus/issues/30)) ([e8edaa1](https://github.com/nodeshift/opossum-prometheus/commit/e8edaa11c2bd35908810477872519d6694fc4857))
...
* upgrade tape from 4.11.0 to 4.13.2 ([#16](https://github.com/nodeshift/opossum-prometheus/issues/16)) ([6233d53](https://github.com/nodeshift/opossum-prometheus/commit/6233d53041727d8b44126b061a18cc411642bb34))
